...
@Entity
@VmsTable(name="instrumentReplicas")
public final class InstrumentReplica implements IEntity<Integer> {
    ...
    public InstrumentReplica() {}

    public InstrumentReplica(int id, String name, String isin, String assetClass, int lotSize, String currency, boolean tradeable) {
